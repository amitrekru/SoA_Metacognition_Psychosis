...
#kbl(spqb_corr_with_sig[4:7,1:3], escape = F, digits = 4, align = 'l', caption = "Uncorrected") %>% kable_styling(bootstrap_options = c("striped", "hover"), full_width = F, position = "center") %>% footnote(general = "1 = p < 0.05\n  2 = p < 0.01\n  3 = p < 0.001\n  4 = p < 0.0001")
...
### Uncomment to run the full classification process from scratch, please note - a long runtime (~4 hours on an Intel i7-7600 computer)
...
#ggarrange(class_acc, class_acc_48, common.legend = TRUE, legend = "bottom")
```
